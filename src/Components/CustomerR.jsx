...
const CustomerR = () => {
  return (
    ...
    >
      Customer <br /> Reviews
      <span className="absolute md:left-70 left-50 top-10 md:top-15 transform -translate-y-1/2 w-1/2 md:w-2/2 h-1 bg-yellow-500"></span>
      <span className="absolute md:right-70 right-50 top-10 md:top-15 transform -translate-y-1/2 w-1/2 md:w-2/2 h-1 bg-yellow-500"></span>
    </h2>
    </div>
  )
}

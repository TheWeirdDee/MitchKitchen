...
export default function SampleMenu() {
  ...
  <h1 className="text-7xl md:mt-10 lg:mt-20 sm:text-5xl md:text-[100px] lg:text-[150px] font-bold frunchy text-red-600 tracking-widest [@media(max-width:499px)]:text-5xl [@media(max-width:499px)]:mb-6">
    SAMPLE MENU
  </h1>
  ...
  <div className="mt-5 flex flex-col items-center sm:items-start">
    ...
    <div className="flex flex-wrap justify-between w-full max-w-xs sm:block gap-2">
      <p className="text-left sm:text-left text-xl tracking-widest">
        Beef / Chicken Soup
      <br />
        with a choice of
      <br />
  ...
  <div className="sm:col-span-2 sm:mx-auto md:col-span-1 flex flex-col items-center">
    <h2 className="font-bold text-3xl mb-6">DESSERTS</h2>
    <div className="flex flex-wrap justify-between w-full max-w-xs sm:block gap-2">
      <p className="text-left sm:text-left text-xl tracking-widest">

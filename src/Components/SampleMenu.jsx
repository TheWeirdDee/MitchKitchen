...
export default function SampleMenu() {
  ...
  <h1 className="text-7xl md:mt-10 lg:mt-20 sm:text-5xl md:text-[100px] lg:text-[150px] font-bold frunchy text-red-600 tracking-widest [@media(max-width:499px)]:text-5xl">
    SAMPLE MENU
  </h1>

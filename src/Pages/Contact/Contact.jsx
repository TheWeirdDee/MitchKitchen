...
const ContactUs = () => {
  ...
  <h1 className="md:text-7xl text-[#ce1126] text-5xl sm:text-5xl font-bold mb-3">CONTACT</h1>
  <h2 className="md:text-6xl text-[#ce1126] text-4xl sm:text-4xl font-bold absolute left-1/2 transform -translate-x-1/2 top-full">US</h2>
</div>
